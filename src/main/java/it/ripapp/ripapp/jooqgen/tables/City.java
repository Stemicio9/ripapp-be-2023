...
public class City extends TableImpl<CityRecord> {
    ...
    /**
     * The column <code>public.city.cityid</code>.
     */
    public final TableField<CityRecord, UUID> CITYID = createField(DSL.name("cityid"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field("uuid_generate_v4()", SQLDataType.UUID)), this, "");
    ...
    /**
     * The column <code>public.city.lon</code>.
     */
    public final TableField<CityRecord, String> LON = createField(DSL.name("lon"), SQLDataType.VARCHAR.nullable(false), this, "");

    /**
     * The column <code>public.city.lat</code>.
     */
    public final TableField<CityRecord, String> LAT = createField(DSL.name("lat"), SQLDataType.VARCHAR.nullable(false), this, "");
